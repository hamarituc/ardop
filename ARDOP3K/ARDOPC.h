...
int EncodePSKIDFrame(char * Callsign, char * Square, unsigned char * bytreturn, UCHAR SessionID);
...
void Mod1Car50Bd4PSK(unsigned char * bytEncodedBytes, int Len, int intLeaderLen);
...
#define MultiACK	0x00
#define AckByCar	0x00		// Rick's Name
#define OVER		0x01
...
#define D4PSKR_200_100_E	0x14
#define D4PSKR_200_100_O	0x15
#define D16APSK_200_100_E	0x16
#define D16APSK_200_100_O	0x17

	//	500 Hz bandwidth Data 
	//	1 Car 4FSK Data mode 500 Hz, 50 baud tones spaced @ 100 Hz 

#define D4PSK_500_50_E	0x18
#define D4PSK_500_50_O	0x19
#define D4PSK_500_100_E	0x1A
#define D4PSK_500_100_O	0x1B
#define D4PSKR_500_100_E	0x1C
#define D4PSKR_500_100_O	0x1D

#define D16APSK_500_100_E	0x1E
#define D16APSK_500_100_O	0x1F

// Frame types &H20 - &H23 reserved 
// 1 Khz Bandwidth Data Modes 
// 4 Car 4PSK Data mode 1000 Hz, 100 baud 

#define D4PSK_1000_100_E	0x20
#define D4PSK_1000_100_O	0x21
// 4 Car 4PSK Data mode 1000 Hz, 100 baud 
#define D4PSKR_1000_100_E	0x22
#define D4PSKR_1000_100_O	0x23


//	2500  bandwidth modes
//	10 Car PSK Data Modes 100 baud

#define D4PSK_2500_100_E	0x24
#define D4PSK_2500_100_O	0x25
#define D4PSKR_2500_100_E	0x26
#define D4PSKR_2500_100_O	0x27

// 10 Car 16APSK

#define D16APSK_2500_100_E	0x28
#define D16APSK_2500_100_O	0x29

// 10 Car  4PSK Data Modes 200 baud

#define D4PSK_2500_200_E	0x2A
#define D4PSK_2500_200_O	0x2B
#define D4PSKC_2500_200_E	0x2C
#define D4PSKC_2500_200_O	0x2D
#define D4PSKCR_2500_200_E	0x2E
#define D4PSKCR_2500_200_O	0x2F
#define ACK					0x30
