...
const char strAllDataModes[14][16] =
		...
		"4PSK.2500.100", 
		"16QAMR.2500.100", "16QAM.2500.100"};

int strAllDataModesLen = 14;
...
BOOL EncodeARQConRequest(char * strMyCallsign, char * strTargetCallsign, enum _ARQBandwidth ARQBandwidth, UCHAR * bytReturn)
{
	...
	CompressCallsign(strTargetCallsign, &bytToRS[0]);  //this uses compression to accept 4, 6, or 8 character Grid squares.

	RSEncode(bytToRS, &bytReturn[8], 6, 2);  // Generate the RS encoding ...now 14 bytes total
